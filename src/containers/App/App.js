		...
		render() {
			return ( <
				...
				render = {
					() => ( <
						section > {
							this.props.movies.now_playing && < MainGallery movies = {
								this.props.movies.now_playing
							}
							/>} {
							this.props.movies.popular && < Gallery genre = {
								'popular'
							}
							data = {
							...
							/>} {
							this.props.movies.top_rated && < Gallery genre = {
								'top_rated'
							}
							data = {
								this.props.movies.top_rated
							}
							/>} < /
							section >
						)
					...
					/> <
					Route path = {
						`/movies/${this.props.specificMovie.title}`
					}
					component = {
						DetailedMovieCard
					}
